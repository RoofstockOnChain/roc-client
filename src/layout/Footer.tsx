  ...
  return (
    <FooterInner component="footer">
      <Container maxWidth="xl">
        <Stack>
          <Box paddingTop="3rem">
            <Typography variant="h5">Ready for the next step?</Typography>
        ...
        <Box paddingBottom="3rem" paddingTop="3rem">
          <Typography variant="body2">
            The offerings available through Roofstock onChain include
            non-fungible tokens referred to as Homes onChain, each representing
            a single-family property-owning limited liability company. Homes
            onChain are not offered through any real estate brokerage firm or
            agent and are not securities as defined by the U.S. Securities and
            Exchange Commission Act. Neither Roofstock onChain nor its agents,
            employees, or affiliates serve as your advisor, agent, broker,
            contracting agent, or fiduciary and do not provide, or offer to
            provide, financial, investment, legal, real estate, or tax advice.
          </Typography>
          <br />
          <Typography variant="body2">
            Transacting on the blockchain, trading cybercurrency, and holding
            real property through a limited liability company may all have tax
            implications. You agree that you are solely responsible for
            determining what, if any, taxes apply to your transaction.
          </Typography>
          <br />
          <Typography variant="body2">
            All Roofstock onChain transactions are facilitated by Smart
            Contracts deployed on the Ethereum blockchain. The Ethereum
            blockchain requires the payment of a transaction fee (a “Gas Fee”)
            for every transaction that occurs on the Ethereum blockchain, and
            thus every blockchain transaction occurring on the Platform. The
            value of the Gas Fee changes, often unpredictably, and is entirely
            outside of the control of Roofstock onChain. You agree that under no
            circumstances will a contract, agreement, offer, sale, bid, or other
            transaction be invalidated, revocable, retractable, or otherwise
